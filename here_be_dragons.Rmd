...
### Independent error
To show that the bias in the better estimate mode is due to the observations we do another set of runs with the analytic solution and independent error.
```{r}
runs <- 10000
...
plot_grid(upper_plot,
          hist_plot,
          nrow = 2)
plot_grid(upper_plot, #Dims: 750,834 
          scatter_hist,
          nrow = 2,
