...
## Load dependencies
```{r}
#remotes::install_github("traitecoevo/hmde@24884ae847095f8163fb6bff6c03918c3147aa4f", force = TRUE)
...
beta_prior_testing <- list(
  average_means_test = list( #Beta_c priors take transformation
    prior_means = c(mean(c(10 - mean(obs_data_frame$y_obs), 
